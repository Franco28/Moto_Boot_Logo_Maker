            ...
            else
            {
                if (result is UpdateInfoEventArgs args)
                {
                    ...
                    else
                    {
                        ...
                        if (ReportErrors)
                        {
                            MessageBox.Show("Download error", "", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                    }
                }
            }
        ...
        private static void ShowError(Exception exception)
        {
            ...
            else
            {
                if (ReportErrors)
                {
                    ...
                    {
                        MessageBox.Show("Download error", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    else
                    {
